...
# default_det_config = '/home/shr/code/gcn_vivit/.vscode/demo/faster_rcnn_r50_coco.py'
# default_det_ckpt = (
#     'https://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/faster_rcnn_r50_fpn_1x_coco-person/'
#     'faster_rcnn_r50_fpn_1x_coco-person_20201216_175929-d022e227.pth')

default_det_config = '/home/code/video_model/.vscode/resources/faster_rcnn_r50_coco.py'
default_det_ckpt = '/home/code/video_model/resources/ckpt/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15.pth'

default_pose_config = '/home/code/video_model/.vscode/resources/hrnet_coco.py'
default_pose_ckpt = '/home/code/video_model/resources/ckpt/hrnet_w32_coco_256x192-c78dce93_20200708.pth'
...
def parse_args():
    ...
    parser.add_argument('--video-list', type=str, help='the list of source videos',
                        default="/home/code/video_model/video_list_wubao")
                        # default="/home/shr/code/gcn_vivit/.vscode/test_extract/full_list.list")
    # * out should ends with '.pkl'
    parser.add_argument('--out', type=str, help='output pickle name',
                        # default="/home/shr/code/gcn_vivit/.vscode/demo/kinetic24_annos.pkl")
                        default="/home/code/video_model/video_list.pkl")
