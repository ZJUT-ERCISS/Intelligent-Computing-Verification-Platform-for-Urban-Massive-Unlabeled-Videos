...
from distance import caculate_distance
...
def parse_args():
    ...
    # parser.add_argument('-in','--video', help="input path", required=True)  
    # /home/tmp/cut/raw/video_walk/video_walk_slice1.avi
    # parser.add_argument('-out','--out_filename', help="out path", required=True)
    # /home/tmp/res/video/infer_video_walk_slice1.avi
    
    parser.add_argument(
        '--config',
        default='/home/shihr/code/video_model/.vscode/infer/model_config.py',
    ...
    parser.add_argument(
        '--det-config',
        default='/home/shihr/code/video_model/.vscode/resources/faster_rcnn_r50_coco.py',
    ...
    parser.add_argument(
        '--label-map',
        default='/home/shihr/code/video_model/tools/ntu_kin_144.txt',
        help='label map file')
    parser.add_argument(
...
def infer_video(input, output):
    ...
    results = inference_recognizer(model, fake_anno, outputs='cls_head')

    # results = inference_recognizer(model, fake_anno,outputs='backbone.to_latent')

    # if results[0][0][1] < 0.8: # score < 0.8 时执行distance度量
    #     caculate_distance(frame_paths, det_results, h, w ,num_frame)
    
    # results =caculate_distance(fake_anno)

    action_label = label_map[results[0][0][0]]
...
# infer_video("/home/tmp/cut/raw/shot/shot_slice1_(4.9-15.1).mp4",
#             "/home/tmp/res/infer_show_res.mp4")

# infer_video("/home/shihr/video/cam2.avi",
#             "/home/shihr/video/res/infer_res.mp4")
