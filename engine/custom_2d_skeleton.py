...
default_det_config = '/home/shr/code/pyskl/demo/faster_rcnn_r50_fpn_2x_coco.py'
default_det_ckpt = ('http://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/'
                    'faster_rcnn_r50_fpn_2x_coco/faster_rcnn_r50_fpn_2x_coco_'
                    'bbox_mAP-0.384_20200504_210434-a5d8aa15.pth')

default_pose_config = '/home/shr/code/gcn_vivit/.vscode/demo/hrnet_coco.py'
default_pose_ckpt = (
...
def parse_args():
    ...
    parser.add_argument('--video-list', type=str, help='the list of source videos',
                        default="/home/shr/code/gcn_vivit/.vscode/test_extract/left_part_kin24.list")
    ...
    parser.add_argument('--out', type=str, help='output pickle name',
                        ...
                        default="/home/shr/code/gcn_vivit/.vscode/test_extract/kin_anno.pkl")
