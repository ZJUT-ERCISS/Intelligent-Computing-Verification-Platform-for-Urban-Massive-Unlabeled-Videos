...
from utils.misc import cache_checkpoint, mc_off, mc_on, test_port
...
def inference_pytorch(args, cfg, data_loader):
    ...
    # print(f'outputs: {outputs}') # list 包含每个视频的属于每个类的概率(narray数组)(Num_Video, 144)
...
def main():
    ...
    if rank == 0:
        ...
        dataset.dump_results(outputs, out=out) # ./work_dir/result.pkl
        if eval_cfg: 
            # evaluate
